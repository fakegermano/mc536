...
teams_file = open(os.path.join(src_dir, "teams.txt"), "r")
teams = teams_file.readlines()
for i in range(0, len(teams)):
    teams[i] = teams[i].strip()

formations_file = open(os.path.join(src_dir, "formations.txt"), "r")
...
estado_estadios_file = open(os.path.join(src_dir, "estado_estadios.txt"), "r")
...
nome_estadios_file = open(os.path.join(src_dir, "nome_estadios.txt"), "r")
nome_estadios = nome_estadios_file.readlines()
for i in range(0, len(nome_estadios)):
    nome_estadios[i] = nome_estadios[i].strip()

capacidade_estadios_file = open(os.path.join(src_dir, "capacidade_estadios.txt"), "r")
...
placar_partidas_file = open(os.path.join(src_dir, "placar_partida.txt"), "r")
